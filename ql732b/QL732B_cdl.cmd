...
# define WL/BL banks
define_WL_bank 0 -range {0 421} -WL_prefix {ttl_wl ttr_wl} -parent psm -rows {0 14}
define_WL_bank 1 -range {0 421} -WL_prefix {tbl_wl tbr_wl} -parent psm -rows {15 29}
...
# row/WL information
define_row {0 29} -WL_range {{1 28},{29 56},{57 84},{85 112},{113 140},{141 168},{169 196},{197 224},{225 252},{253 281},{282 309},{310 337},{338 365},{366 393},{394 421},{422 449},{450 477},{478 505},{506 533},{534 561},{562 589},{590 617},{618 645},{646 674},{675 702},{703 730},{731 758},{759 786},{787 814},{815 842}}
